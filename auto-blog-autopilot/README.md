...
2. **심사 기준**: 콘텐츠 양·트래픽에 정해진 최소치는 없지만, 실질적인
   정보가 담긴 글이 최소 20~30편 이상 있고, 개인정보처리방침 페이지가
   있고, 정책 위반 콘텐츠(성인물, 저작권 침해 등)가 없어야 승인 확률이
   높습니다. 지금 발행량(40편 이상, 매일 자동 발행 이력)이면 콘텐츠
   요건은 충분한 편이고, 개인정보처리방침·소개 페이지도 이미 있습니다.
   보통 심사에 며칠~몇 주가 걸립니다 — 여기가 유일하게 "사람이 기다려야
   하는" 구간입니다.
